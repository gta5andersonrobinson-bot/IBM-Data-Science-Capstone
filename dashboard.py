...
Original file is located at
    https://colab.research.google.com/drive/11blrj8Y5xYBLU4YN-gmObkXHKfOnskm4
"""
...
# Callback for plotting the graphs
@app.callback(
...
def update_output_container(selected_statistics, input_year):
    if selected_statistics == 'Recession Period Statistics':
        ...
        Y_chart2 = dcc.Graph(figure=px.line(mas, x='Month', y='Automobile_Sales', title=f'Total Monthly Automobile Sales in {input_year}'))
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data, values='Advertising_Expenditure', names='Vehicle_Type', title=f'Advertisement Expenditure by Type in {input_year}'))
